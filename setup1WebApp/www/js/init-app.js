...
app.initEvents = function() {
    ...
    el = document.getElementById("id_btn_connect") ;
    el.addEventListener(evt, connectHandler, false) ;
	
	el = document.getElementById("id_btn_disconnect");
	el.addEventListener(evt, disconnectHandler, false);
